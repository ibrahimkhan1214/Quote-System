...
<meta charset="UTF-8">
<title>Login</title>
<link rel="stylesheet" href="HQlogin.css">
</head>
<?php
...
<body class="login_body">
  ...
  <center>
<form class="form" action="HQlogin.php" method="POST">
<h1 class="login_heading">Headquarters Login</h1>
<input class="user" type="text" placeholder="Username" name="userid"><br/><br/>
...
if(isset($_POST['submit']))
{
                ...
                try{
                        ...
                        $sql = "SELECT * FROM headquarters_users WHERE username = '$userid' AND password = '$password'";
                        $rs = $pdo1->prepare($sql);
                        ...
                        if(!$rows){
                                ...
                                header("location:HQinterface.php");
                        }
                }
